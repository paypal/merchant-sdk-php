    ...
    <form id="form1" action ="SetAuthFlowParam.php" >
        <div id="request_form">
            ...
            <div class="param_value">
                <input type="text" name="returnURL" id="returnURL" size ="90" value =<?php echo $returnUrl?> />
            </div>
            <div class="param_name">Cancel URL</div>
            <div class="param_value">
                <input type="text" name="cancelURL" id="cancelURL" size ="90" value=<?php echo $cancelUrl?>/>
            </div>
            
            <div class="param_name">Logout URL</div>
            <div class="param_value">
                <input type="text" name="logoutURL" id="LogoutURL" size ="90" value=<?php echo $cancelUrl ?> />
            </div>
