...
<body>
	<div id="wrapper">
		...
		<br>
		<div id="request_form">
			<form method="POST" action="ParallelPayment.php">
				<div class="params">
				...
				<div class="param_name">Receiver email.
					</div>
					<div class="param_value">
						<input type="text" name="receiverEmail_0"
							value="platfo_1255170694_biz@gmail.com 
							" size="50" maxlength="260" />
					</div>
					<div class="param_value">
						<input type="text" name="receiverEmail_1"
