...
<html>
    <head>
        ...
        <script type="text/javascript">
            function formDate(){
            	var d = new Date();
            	var startDate = d.getFullYear() + "-" + (d.getMonth() +1) + "-" + d.getDate() + "T" + d.getHours() + ":" + d.getMinutes() + ":" + d.getSeconds() + ":" + d.getMilliseconds() + "Z" ;
            	document.getElementById("billingStartDate").value = startDate;
            }
        </script>
    </head>
    <body onload='formDate();'>
        ...
        <div id="wrapper">
            ...
            <form method="POST" action="CreateRecurringPaymentsProfileUsingCreditCard.php">
                <div id="request_form">
                    <div class="params">
                    ...
                    <div class="params">
                        ...
                        <div class="param_value">
                            <textarea rows="5" cols="60" name="profileDescription" >RecurringBilling Using CreditCard</textarea>
                        </div>
                    </div>
                    ...
                    <table class="params_name">
                        ...
                        <tr>
                            ...
                            <td><span class="param_value"> <input type="text"
                                id="currencyCode" name="currencyCode" value="USD" /> </span>
                            </td>
                        </tr>
                    </table>
