...
<body>
	<div id="wrapper">
		...
		<div id="header">
			<h3>EnterBoarding</h3>
			<div id="apidetails">EnterBoarding establishes an integration program
				with a merchant, specifies a merchant information</div>
		</div>
		<form method="POST" action="EnterBoarding.php">
			<div id="request_form">
				...
				<div class="params">
					<div class="param_name">Product List(indicates the PayPal products
						you are implementing for this merchant)</div>
					<div class="param_value">
				...
				<table class="params">
					...
					<tr>
						<td class="param_value"><input type="text" name="accNum" value=""
							maxlength="260" /></td>
						<td class="param_value"><input type="text" name="accName" value=""
							maxlength="260" /></td>
				...
				<table class="params">
					...
					<tr>
						<td class="param_value"><input type="text" name="businessName"
							value="Grocery" maxlength="260" /></td>
				...
				<table class="params">
					...
					<tr>
						...
						<td class="param_value"><input type="text" name="lastName"
							value="Doe" maxlength="260" /></td>
						<td class="param_value"><input type="text" name="ownerPhone"
							value="247365935" maxlength="260" /></td>
						<td class="param_value"><input type="text" name="ownerMail"
							value="xyz@paypal.com" maxlength="260" /></td>
						<td class="param_value"><input type="text" name="SSN" value=""
							maxlength="260" /></td>
					</tr>
				</table>
				<div class="submit">
