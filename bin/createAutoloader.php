...
//$fileList1 = glob_recursive($libraryPath . '*.php');
//$fileList2 = glob_recursive($servicePath . '*.php');
//$fileList = array_merge($fileList1, $fileList2);
$fileList = glob_recursive($path . '*.php');

$classes  = array();

foreach ($fileList as $file) {
    // Trim off the absolute path
   if(strpos($file,$libraryPath) > -1)
   {
    	$filename = str_replace($libraryPath, '', $file);
   }
   else
        $filename = str_replace($servicePath, '', $file);
